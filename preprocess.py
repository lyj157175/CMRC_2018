...
from preprocessold.prepro_utils import *
...
def json2features(input_file, 
    ...
    json.dump(examples, open(output_example_file, 'w'))
    ...
    json.dump(features, open(output_feature_file, 'w'))
